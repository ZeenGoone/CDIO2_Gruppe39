...
public class Spilleplade {
	...
	spilleplade[8] =  new Felt("The Werewall (werewolf-wall)", -80, Color.RED, Color.BLACK, "Du blev jagtet af varulve, og løb så hurtigt, at du tabte 80, men hurtigt kom videre!");
